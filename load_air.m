...
% 21.09.11 - Update for mock-up phone RIRs with bottom-top phone (MJ)
%--------------------------------------------------------------------------
...
switch airpar.rir_type
    ...
    case 2
        ...
        if ~isfield(airpar,'mock_up_type');
            airpar.mock_up_type = 1; % Default: BB mock-up
        end;
    otherwise
...
if airpar.rir_type == 1 % binaural
    ...
    switch airpar.mock_up_type
        case 1
            file_name=['air_phone_',room_string,'_',pos_string,'_',...
                num2str(airpar.channel)];
        case 2
            file_name=['air_phone_BT_',room_string,'_',pos_string,'_',...
                num2str(airpar.channel)];
        otherwise
            error('load_air: mock-up type not supported / does not exist');
    end;
end;
%--------------------------------------------------------------------------
% load rir
